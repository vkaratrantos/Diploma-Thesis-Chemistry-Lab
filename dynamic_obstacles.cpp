            ...
            if (ss >> marker_id) {
                ...
                if (marker_id == 0) {
                    ...
                    try {
                        ...
                        if (marker_id == 1) { tx = -0.155; ty = -0.15; tz = 0.1; } 
                        else if (marker_id == 2) { tx = -0.071; ty = -0.15; tz = 0.1; } 
                        else if (marker_id == 3) { tx = 0.022; ty = -0.15; tz = 0.1; } 
                        else if (marker_id == 4) { tx = 0.117; ty = -0.15; tz = 0.1; } 
                        else if (marker_id == 5) { tx = 0.186; ty = -0.15; tz = 0.1; } 
                        else if (marker_id == 6) { tx = -0.186; ty = -0.15; tz = 0.1; } 
                        else {
                            continue; 
                        }
                    }
