...
int main(int argc, char * argv[])
{
    ...
    while (rclcpp::ok()) {
        ...
        // Roll is completely free. Pitch/Yaw get 0.3 rad tolerance.
        ...
        for (int i = 1; i <= 180; i += 1) {
            double angle_in_rads = (i * 1) * (M_PI / 180.0);
        ...
        for (double roll : roll_offsets) {
            ...
            bool found_valid_solution = kinematic_state->setFromIK(joint_model_group, target, 0.02, collision_callback);
