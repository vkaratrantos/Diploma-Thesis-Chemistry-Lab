...
// ---- Test tubes ------------------------------------------------------------
static constexpr double TUBE_HEIGHT = 0.1;
static constexpr double TUBE_RADIUS = 0.008;
...
// ---- Mixer -----------------------------------------------------------------
static constexpr double MIXER_HEIGHT   = 0.1;
static constexpr double MIXER_RADIUS   = 0.04;      // updater used 0.05; unified
static constexpr double MIXER_CENTER_Z = 0.05;      // updater used 0.07; unified
static constexpr double MIXER_Y_OFFSET = 0.07;   // mixer body = marker_6 + this, in y
...
static constexpr double MIXER_TOP_Z = MIXER_CENTER_Z + MIXER_HEIGHT / 2.0;   // 0.100
...
static constexpr double POUR_X_OFFSET = 0.08;   // TCP x = marker_x + this
static constexpr double POUR_Y_OFFSET = 0.205;  // TCP y = marker_y + this (0.07 mixer + 0.135 gripper reach)
...
static constexpr double MIXER_FALLBACK_MARKER_X = -0.247;   // measured by the vision node
static constexpr double MIXER_FALLBACK_MARKER_Y = -0.288;   // measured by the vision node
