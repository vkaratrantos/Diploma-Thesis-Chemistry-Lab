...
static constexpr double GRASP_Z        = 0.1;
static constexpr double POUR_Z         = 0.20;
static constexpr double APPROACH_DIST  = 0.10;
static constexpr double LIFT_DIST      = 0.12;
...
int main(int argc, char * argv[])
{
    ...
    while (rclcpp::ok())
    {
        ...
        if (line.rfind("TASK", 0) == 0 || line.rfind("task", 0) == 0)
        {
            ...
            try
            {
                marker_id = std::stoi(line.substr(4));
            }
